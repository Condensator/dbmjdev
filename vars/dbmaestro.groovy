...
def prepareReportFiles()
{
	...
	dir(dbm_report_files_dir) {
		...
		echo "writing to \"${dbm_report_files_dir}\\style.css\""
		new File("${dbm_report_files_dir}\\style.css").write(styles)
	}
}
